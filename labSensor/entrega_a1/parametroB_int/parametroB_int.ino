...
long int temperatura = 0;   // Valor da temperatura
...
long int tempBparameterInt(float R){
  return 29815*B/(B*100 + 29815*log(R/R0));
}
...
void loop(){
 ...
 temperatura = tempBparameterInt(Rntc); // Obtenção da temperatura a partir do calculo de Steinhart-Hart
