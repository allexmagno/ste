...
SOURCEFILES_QUOTED_IF_SPACED=Timer.cpp Singleton.cpp

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Timer.o ${OBJECTDIR}/Singleton.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Timer.o.d ${OBJECTDIR}/Singleton.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Timer.o ${OBJECTDIR}/Singleton.o

# Source Files
SOURCEFILES=Timer.cpp Singleton.cpp
...
dist/${CND_CONF}/${IMAGE_TYPE}/Timer.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC_DIR}/avr-objdump -h -S "dist/${CND_CONF}/${IMAGE_TYPE}/Timer.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}" > "dist/${CND_CONF}/${IMAGE_TYPE}/Timer.X.${IMAGE_TYPE}.lss"
